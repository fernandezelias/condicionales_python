...
temperatura_1 = float(input("Ingresa la primera temperatura:\n"))
temperatura_2 = float(input("Ingresa la segunda temperatura:\n"))
temperatura_3 = float(input("Ingresa la tercera temperatura:\n"))
